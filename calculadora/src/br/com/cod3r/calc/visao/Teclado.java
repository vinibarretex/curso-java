...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		...
		// Linha 1
		c.gridwidth = 2;
		/* ocupa duas casas, esse comando se aplica pra todos 
		 * os componentes abaixo, entao é necessário voltar para 
		 * o valor 1
		 */
	...
	public void actionPerformed(ActionEvent e) {
		/* o método getSource retorna um Object, então é 
		 * necessário fazer o cast pra (JButton)
		 */
